...
Tests whether an AI system can act as a safety guardrail by generating and executing code to
protect web navigation agents from unsafe actions based on user constraints.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/mind2web_sc`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/mind2web_sc) |
| Group | Safeguards |
| Total samples | 200 |
...
```bash
inspect eval inspect_evals/mind2web_sc \
  --sample-id "<sample-id>" \
