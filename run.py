#!/usr/bin/env python3
"""Run ONE problem of mind2web_sc through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/mind2web_sc"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one mind2web_sc problem via TrustedRouter")
